...
<x-content :title="[
    ...
    <div class="row">
        <div class="col-4">
            <form target="_blank" action="{{ route('laporan.harian') }}" class="card card-primary card-outline">
        ...
        <div class="col-md-4">
            <form target="_blank" action="{{ route('laporan.perbulan') }}" class="card card-primary card-outline">
                <div class="card-header">
                    Laporan Per-bulan
                </div>
                <div class="card-body">
